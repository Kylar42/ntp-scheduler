...
public class DBSetup {
    ...
    private static final String USER_GRANT = "GRANT ALL ON DATABASE hr_info to "+ConnectionPool.getInstance().dbUser;//+" identified by '"+ConnectionPool.getInstance().dbPassword+"';";
